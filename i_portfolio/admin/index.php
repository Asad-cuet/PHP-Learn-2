...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>  <!-- Jquery Library -->
  ...
  <style>
    ...
    * {
    ...
    .bg-img {
      /* The image used */
      background-image:linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("uploads/<?php echo $image; ?>");
...
<div class="w3-container my-dark">
     <div class="w3-center w3-margin"><h3>Asadul Islam Panel</h3></div>
...
<form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" enctype="multipart/form-data">
          ...
          <div class="w3-panel">
           ...
           <input type="submit" value="Login" name="login_" class="w3-button my-dark"><br>
           </div>
